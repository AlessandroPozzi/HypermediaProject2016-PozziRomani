<?php
	...
	/**
    *  Builds an instance of a multiple topic assistance page related to the device given as
	...
	function assistanceFor_Target(){
	   ...
	   $mysqli = new mysqli("localhost", "timhypermediaproject2016", "", "my_timhypermediaproject2016");
        //sql query
         ...
         else{ // query of the specific assistance
           $query ="SELECT * FROM assistance WHERE name="."'".$name."'";
           
             // query of the other assistance services related to the same device, for GT pattern purposes
         ...
         if(!($orientation==null)){   
           ...
           $orientation_parents->item(0)->appendChild($neworientation2);
            ...
            }else{// remove that part of the page if there are no results
